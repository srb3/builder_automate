...
variable "license_destination_path" {
  description = "The path to the remote automate license"
  type = "string"
  default = "/tmp/.a2_license"
}

variable "script_path" {
  description = "The path the to setup sctipt"
  type = "string"
  default = "scripts/a2_setup.sh"
}

variable "scirpt_tmp_path" {
  description = "The path the to setup sctipt temp file"
  type = "string"
  default = "scripts/t_a2_setup.sh"
}

variable "temp_script_destination_path" {
  description = "The path to the remote copy of the setup script"
  type = "string"
  default = "/tmp/t_a2_setup.sh"
}

variable "heap_size" {
  description = "The size of the automate servers elasticsearch jvm heap"
  type = "string"
  default = "2g"
}
